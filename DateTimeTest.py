...
class DateTimeTestCase(unittest.TestCase):
    ...
    def testTimeTruncated(self):
        print '\n----- testTimeTruncated -----'
        when = DateTime.MomentFactory.make_moment("now")

        when = DateTime.MomentFactory.make_moment("10:11:12")
    ...
    def testTimeDateFirst(self):
        print '\n----- testTimeDateFirst -----'
        when = DateTime.MomentFactory.make_moment("20 March 1920 10:11:12")
        self.__assert_time(when, 1920, 3, 20, 10, 11, 12)

        when = DateTime.MomentFactory.make_moment("April 21, 1922 12:13:14")
        self.__assert_time(when, 1922, 4, 21, 12, 13, 14)

        when = DateTime.MomentFactory.make_moment("5/22/1923 13:14:15")
        self.__assert_time(when, 1923, 5, 22, 13, 14, 15)

        when = DateTime.MomentFactory.make_moment("23/6/1924 14:15:16")
        self.__assert_time(when, 1924, 6, 23, 14, 15, 16)

        when = DateTime.MomentFactory.make_moment("1920-03-20 15:16:17")
        self.__assert_time(when, 1920, 3, 20, 15, 16, 17)

    def testTimeOneAsterisk(self):
        print '\n----- testTimeOneAsterisk -----'
        when = DateTime.MomentFactory.make_moment("20 * 1920 10:11:12")
        self.__assert_time(when, 1920, None, 20, 10, 11, 12)

        when = DateTime.MomentFactory.make_moment("April 21, * 12:13:14")
        self.__assert_time(when, None, 4, 21, 12, 13, 14)

        when = DateTime.MomentFactory.make_moment("5/22/1923 *:14:15")
        self.__assert_time(when, 1923, 5, 22, None, 14, 15)

        when = DateTime.MomentFactory.make_moment("*/23/1924 14:15:16")
        self.__assert_time(when, 1924, None, 23, 14, 15, 16)

        when = DateTime.MomentFactory.make_moment("1920-03-20 15:*:17")
        self.__assert_time(when, 1920, 3, 20, 15, None, 17)

        when = DateTime.MomentFactory.make_moment("1920-03-20 15:16:*")
        self.__assert_time(when, 1920, 3, 20, 15, 16, None)

    def testTimeMultipleAsterisk(self):
        print '\n----- testTimeMultipleAsterisk -----'
        when = DateTime.MomentFactory.make_moment("20 * 1920 10:11:*")
        self.__assert_time(when, 1920, None, 20, 10, 11, None)

        when = DateTime.MomentFactory.make_moment("* 21, * 12:13:14")
        self.__assert_time(when, None, None, 21, 12, 13, 14)

        when = DateTime.MomentFactory.make_moment("5/22/1923 *:14:*")
        self.__assert_time(when, 1923, 5, 22, None, 14, None)

        when = DateTime.MomentFactory.make_moment("*/23/1924 *:15:16")
        self.__assert_time(when, 1924, None, 23, None, 15, 16)

        when = DateTime.MomentFactory.make_moment("*-*-20 15:*:17")
        self.__assert_time(when, None, None, 20, 15, None, 17)

    def testTimeDateSecond(self):
        print '\n----- testTimeDateSecond -----'
        when = DateTime.MomentFactory.make_moment("10:11:12 20 March 1920")
        self.__assert_time(when, 1920, 3, 20, 10, 11, 12)

        when = DateTime.MomentFactory.make_moment("12:13:14 April 21, 1922")
        self.__assert_time(when, 1922, 4, 21, 12, 13, 14)

        when = DateTime.MomentFactory.make_moment("13:14:15 5/22/1923")
        self.__assert_time(when, 1923, 5, 22, 13, 14, 15)

        when = DateTime.MomentFactory.make_moment("14:15:16 23/6/1924")
        self.__assert_time(when, 1924, 6, 23, 14, 15, 16)

        when = DateTime.MomentFactory.make_moment("15:16:17 1920-03-20")
        self.__assert_time(when, 1920, 3, 20, 15, 16, 17)

    def testTimeDaysFirst(self):
        print '\n----- testTimeDaysFirst -----'
        when = DateTime.MomentFactory.make_moment("mondays,TUES 10:11:12")
        self.__assert_days(when=when,
                           mon=True,  tue=True,  wed=False, thu=False,
                           fri=False, sat=False, sun=False,
                           hour=10, minute=11, second=12)

        when = DateTime.MomentFactory.make_moment(
        ...
        when = DateTime.MomentFactory.make_moment("FRI 13:14:15")
        self.__assert_days(when=when,
                           mon=False, tue=False, wed=False, thu=False,
                           fri=True,  sat=False, sun=False,
                           hour=13, minute=14, second=15)

        when = DateTime.MomentFactory.make_moment("sun *:15:16")
        self.__assert_days(when=when,
                           mon=False, tue=False, wed=False, thu=False,
    ...
    def testTimeDaysSecond(self):
        print '\n----- testTimeDaysSecond -----'
        when = DateTime.MomentFactory.make_moment("10:11:12 mondays,TUES")
        self.__assert_days(when=when,
                           mon=True,  tue=True,  wed=False, thu=False,
                           fri=False, sat=False, sun=False,
                           hour=10, minute=11, second=12)

        when = DateTime.MomentFactory.make_moment("12:13:14 tuesday, wed")
        self.__assert_days(when=when,
                           mon=False, tue=True,  wed=True,  thu=False,
                           fri=False, sat=False, sun=False,
                           hour=12, minute=13, second=14)

        when = DateTime.MomentFactory.make_moment("13:14:15 FRI")
        self.__assert_days(when=when,
                           mon=False, tue=False, wed=False, thu=False,
                           fri=True,  sat=False, sun=False,
                           hour=13, minute=14, second=15)

        when = DateTime.MomentFactory.make_moment("*:15:16 sun ")
        self.__assert_days(when=when,
                           mon=False, tue=False, wed=False, thu=False,
                           fri=False, sat=False, sun=True,
                           hour=None, minute=15, second=16)
    ...
    def testFirstDateTime(self):
        ...
        print '== one =='
        when = DateTime.MomentFactory.make_moment('*-02-* 12:*:10')
        ...
        # == Carry one, deep
        print '== three =='
        when = DateTime.MomentFactory.make_moment('*-03-* 11:*:10')
        next_firing = when.get_next_occurrence(
    ...
    def testZFirstDayOfWeekTime(self):
        ...
        print '== one =='
        when = DateTime.MomentFactory.make_moment('Mon, Tues 12:*:10')
        next_firing = when.get_next_occurrence(
        ...
        print '== two =='
        when = DateTime.MomentFactory.make_moment('Tues, Thurs 12:*:10')
        next_firing = when.get_next_occurrence(
            datetime.datetime(2014, 03, 11, 12, 11, 10))
        self.__assert_time(next_firing, 2014, 3, 11, 12, 11, 10)

        print '== three =='
        when = DateTime.MomentFactory.make_moment('Wed, Sat, Sun 12:*:10')
        next_firing = when.get_next_occurrence(
            datetime.datetime(2014, 03, 11, 12, 11, 10))
        self.__assert_time(next_firing, 2014, 3, 12, 12, 0, 10)

        print '== four =='
        when = DateTime.MomentFactory.make_moment('Thurs 12:*:10')
        next_firing = when.get_next_occurrence(
            datetime.datetime(2014, 03, 11, 12, 11, 10))
        self.__assert_time(next_firing, 2014, 3, 13, 12, 0, 10)

        print '== five =='
        when = DateTime.MomentFactory.make_moment('Sat, Fri 12:*:10')
        next_firing = when.get_next_occurrence(
            datetime.datetime(2014, 03, 11, 12, 11, 10))
        self.__assert_time(next_firing, 2014, 3, 14, 12, 0, 10)

        print '== six =='
        when = DateTime.MomentFactory.make_moment('Saturday 12:*:10')
        next_firing = when.get_next_occurrence(
            datetime.datetime(2014, 03, 11, 12, 11, 10))
        self.__assert_time(next_firing, 2014, 3, 15, 12, 0, 10)

        print '== seven =='
        when = DateTime.MomentFactory.make_moment('Monday, Sunday 12:*:10')
        next_firing = when.get_next_occurrence(
            datetime.datetime(2014, 03, 11, 12, 11, 10))
        ...
        when = DateTime.MomentFactory.make_moment('Thursday, Friday 12:*:09')
        next_firing = when.get_next_occurrence(
        ...
        when = DateTime.MomentFactory.make_moment('Friday 12:*:10')
        next_firing = when.get_next_occurrence(
    ...
    def testDateTimeIncrement(self):
        ...
        when = DateTime.MomentFactory.make_moment('*-02-* 12:*:10 +2 days')
        next_firing = when.get_next_occurrence(
            datetime.datetime(2013, 03, 01, 12, 00, 10))
        self.__assert_time(next_firing, 2014, 2, 01, 12, 00, 10)
        ...
        when = DateTime.MomentFactory.make_moment('*-01-* 12:*:10 +1 month')
        next_firing = when.get_next_occurrence(
        ...
        when = DateTime.MomentFactory.make_moment('now +77 seconds')
        next_firing = when.get_next_occurrence(
        ...
        when = DateTime.MomentFactory.make_moment('armed +77 seconds')
        next_firing = when.get_next_occurrence(
            datetime.datetime(2013, 01, 12, 12, 00, 10))
        self.__assert_time(next_firing, 2013, 1, 12, 12, 01, 27)
        ...
        when = DateTime.MomentFactory.make_moment('+15 minutes')
        next_firing = when.get_next_occurrence(
            datetime.datetime(2013, 01, 30, 12, 00, 10))
        self.__assert_time(next_firing, 2013, 1, 30, 12, 00, 10)
